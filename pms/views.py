...
def update(request, id):
    ...
    if request.method=="POST":
        ...
        Pensioner.objects.filter(id=id).update(dobf=dobf, rbs=rbs, bps=bps, name=name, pay=pay, dob=dob, doa=doa, dor=dor, dod=dod, fname=fname, fpname=fpname, ppo=ppo, designation=designation, address=address, cnic=cnic, qpay=qpay, ppay=ppay,spay=spay,ui=ui, opay=opay, cat=cat)
